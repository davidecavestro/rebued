...
//		this._context.getUIPersisteer ().register (new PersistenceTreeAdapter (this.treeScrollPane));
		...
		bindTextAreas (
			new TextAreaTableBinder ((JXTable) valuesTable) {
				public int getKeyColumn () {
					return LocalizationTableModel.KEY_COLUMN_INDEX;
				}
				
				public void setCommentAt (String string, int row, int col) {
					((LocalizationTableModel)valuesTable.getModel ()).setCommentAt (string, row, col);
				}

				public String getCommentAt (int row, int col) {
					return ((LocalizationTableModel)valuesTable.getModel ()).getCommentAt (row, col);
				}
			},
			new EditorPanel () {
				public JTextField getKeyEditor () {
					return keyTextField;
				}

				public JTextArea getValueEditor () {
		...
		bindTextAreas (
			new TextAreaTableBinder (keysTreeTable) {
				public int getKeyColumn () {
					return KeysTreeTable.KeysTreeTableModel.KEY_COLUMN_INDEX;
				}
				public void setCommentAt (String string, int row, int col) {
					((KeysTreeTable.KeysTreeTableModel)keysTreeTable.getTreeTableModel ()).setCommentAt (string, row, col);
				}

				public String getCommentAt (int row, int col) {
					return ((KeysTreeTable.KeysTreeTableModel)keysTreeTable.getTreeTableModel ()).getCommentAt (row, col);
				}
			},
			new EditorPanel () {
				public JTextField getKeyEditor () {
					return keyTextField1;
				}

				public JTextArea getValueEditor () {
					return valueTextArea1;
				}

				public JTextArea getCommentEditor () {
					return commentTextArea1;
				}
			}
		);
...
//		}
    ...
    private void initComponents() {
        ...
        valueTextArea1 = new javax.swing.JTextArea();
        ...
        tree_table_splitPane.addComponentListener(new java.awt.event.ComponentAdapter() {
            public void componentShown(java.awt.event.ComponentEvent evt) {
                tree_table_splitPaneComponentShown(evt);
            }
        });
    ...
    valuesTablePanel.setMinimumSize(null);
    ...
    * editor (shortcut per cancellazione
        */
        ...
        gridBagConstraints.insets = new java.awt.Insets(5, 8, 5, 2);
        ...
        jScrollPane5.setMinimumSize(new java.awt.Dimension(200, 150));
        ...
        keysTreeTable.setMinimumSize(new java.awt.Dimension(300, 400));
        ...
        keysTreeTable.setPreferredSize(null);
        ...
        * editor (shortcut per cancellazione
            */
            ...
            editorPanel1.setLayout(new java.awt.GridBagLayout());

            editorPanel1.setPreferredSize(new java.awt.Dimension(233, 60));
            //_context.getUIPersisteer ().register (new PersistencePanelAdapter (editorPanel, "editorPanel"));
            javax.help.CSH.setHelpIDString (editorPanel, _context.getHelpManager ().getResolver ().resolveHelpID (HelpResources.EDITOR_PANEL));
            jLabel7.setFont(new java.awt.Font("Dialog", 0, 12));
            org.openide.awt.Mnemonics.setLocalizedText(jLabel7, java.util.ResourceBundle.getBundle("com.davidecavestro.rbe.gui.res").getString("&Comment:"));
            gridBagConstraints = new java.awt.GridBagConstraints();
            gridBagConstraints.gridx = 0;
            gridBagConstraints.gridy = 2;
            gridBagConstraints.fill = java.awt.GridBagConstraints.BOTH;
            gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
            gridBagConstraints.insets = new java.awt.Insets(5, 8, 5, 2);
            editorPanel1.add(jLabel7, gridBagConstraints);

            jLabel8.setFont(new java.awt.Font("Dialog", 0, 12));
            org.openide.awt.Mnemonics.setLocalizedText(jLabel8, java.util.ResourceBundle.getBundle("com.davidecavestro.rbe.gui.res").getString("&Value:"));
            gridBagConstraints = new java.awt.GridBagConstraints();
            gridBagConstraints.gridx = 0;
            gridBagConstraints.gridy = 1;
            gridBagConstraints.fill = java.awt.GridBagConstraints.BOTH;
            gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
            gridBagConstraints.insets = new java.awt.Insets(5, 8, 5, 2);
            editorPanel1.add(jLabel8, gridBagConstraints);
            ...
            gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHEAST;
            gridBagConstraints.insets = new java.awt.Insets(5, 2, 5, 2);
            editorPanel1.add(jPanel6, gridBagConstraints);

            commentTextArea1.setFont(new java.awt.Font("Monospaced", 0, 12));
            commentTextArea1.setRows(2);
            commentTextArea1.setToolTipText(java.util.ResourceBundle.getBundle("com.davidecavestro.rbe.gui.res").getString("commentTextAreaTooltip"));
            commentTextArea1.setWrapStyleWord(true);
            commentTextArea1.setBorder(javax.swing.BorderFactory.createEtchedBorder());
            commentTextArea1.addFocusListener(new java.awt.event.FocusAdapter() {
                public void focusGained(java.awt.event.FocusEvent evt) {
                    commentTextArea1FocusGained(evt);
                }
            });
            commentTextArea1.addKeyListener(new java.awt.event.KeyAdapter() {
                public void keyPressed(java.awt.event.KeyEvent evt) {
                    commentTextArea1KeyPressed(evt);
                }
            });

            jScrollPane6.setViewportView(commentTextArea1);
            ...
            gridBagConstraints.weighty = 1.0;
            gridBagConstraints.insets = new java.awt.Insets(5, 2, 5, 2);
            editorPanel1.add(jScrollPane6, gridBagConstraints);

            valueTextArea1.setFont(new java.awt.Font("Monospaced", 0, 12));
            valueTextArea1.setRows(2);
            valueTextArea1.setToolTipText(java.util.ResourceBundle.getBundle("com.davidecavestro.rbe.gui.res").getString("valueTextAreaTooltip"));
            valueTextArea1.setWrapStyleWord(true);
            valueTextArea1.setBorder(javax.swing.BorderFactory.createEtchedBorder());
            valueTextArea1.addKeyListener(new java.awt.event.KeyAdapter() {
                public void keyPressed(java.awt.event.KeyEvent evt) {
                    valueTextArea1KeyPressed(evt);
                }
            });

            jScrollPane7.setViewportView(valueTextArea1);
            ...
            gridBagConstraints.weighty = 1.0;
            gridBagConstraints.insets = new java.awt.Insets(5, 2, 5, 2);
            editorPanel1.add(jScrollPane7, gridBagConstraints);

            jLabel9.setFont(new java.awt.Font("Dialog", 0, 12));
            jLabel9.setLabelFor(keyTextField);
            org.openide.awt.Mnemonics.setLocalizedText(jLabel9, java.util.ResourceBundle.getBundle("com.davidecavestro.rbe.gui.res").getString("Key:"));
            gridBagConstraints = new java.awt.GridBagConstraints();
            gridBagConstraints.gridx = 0;
            gridBagConstraints.gridy = 0;
            gridBagConstraints.fill = java.awt.GridBagConstraints.BOTH;
            gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
            gridBagConstraints.insets = new java.awt.Insets(5, 8, 5, 2);
            editorPanel1.add(jLabel9, gridBagConstraints);

            keyTextField1.setEditable(false);
            keyTextField1.setFont(new java.awt.Font("Monospaced", 1, 12));
            keyTextField1.setForeground(keyForegroundColor);
            keyTextField1.setToolTipText(java.util.ResourceBundle.getBundle("com.davidecavestro.rbe.gui.res").getString("currentKeyFieldTooltip"));
            keyTextField1.setOpaque(false);
            gridBagConstraints = new java.awt.GridBagConstraints();
            gridBagConstraints.gridx = 1;
            gridBagConstraints.gridy = 0;
            gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
            gridBagConstraints.insets = new java.awt.Insets(5, 2, 5, 2);
            editorPanel1.add(keyTextField1, gridBagConstraints);

            jSplitPane2.setBottomComponent(editorPanel1);
	...
	private void jPanel1ComponentShown (java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_jPanel1ComponentShown
		keysTreeTable.requestFocusInWindow ();
	}//GEN-LAST:event_jPanel1ComponentShown

	private void tree_table_splitPaneComponentShown (java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_tree_table_splitPaneComponentShown
		valuesTable.requestFocusInWindow ();
	}//GEN-LAST:event_tree_table_splitPaneComponentShown

	private void valueTextArea1KeyPressed (java.awt.event.KeyEvent evt) {//GEN-FIRST:event_valueTextArea1KeyPressed
		smartTextAreaKeyPressed (evt);
	}//GEN-LAST:event_valueTextArea1KeyPressed

	private void commentTextArea1KeyPressed (java.awt.event.KeyEvent evt) {//GEN-FIRST:event_commentTextArea1KeyPressed
		smartTextAreaKeyPressed (evt);
	}//GEN-LAST:event_commentTextArea1KeyPressed

	private void commentTextArea1FocusGained (java.awt.event.FocusEvent evt) {//GEN-FIRST:event_commentTextArea1FocusGained
// TODO add your handling code here:
	}//GEN-LAST:event_commentTextArea1FocusGained
...
//			}
    ...
    private javax.swing.JTextArea valueTextArea1;
	...
	private class LocalizationTableModel extends AbstractTableModel implements ResourceBundleModelListener {
		...
		public final static int KEY_COLUMN_INDEX = 0;
		...
		public String getCommentAt (int rowIndex, int columnIndex) {
			switch (columnIndex) {
				case KEY_COLUMN_INDEX: {
					return null;
				}
...
//				this.fireTableDataChanged ();
		...
		public boolean isCellEditable(int rowIndex, int columnIndex) {
			switch (columnIndex) {
				case KEY_COLUMN_INDEX: {
					return _context.getApplicationOptions ().isKeyEditingEnabled ();
				}
				default: {
					return true;
				}
...
//			this.fireTreeStructureChanged (this, new TreePath (new Object[]{e.getKeys ()[0], e.getLocale (), this.getRoot ()}));
			...
			if (e.getType ()==ResourceBundleModelEvent.INSERT){
				...
				this.fireTreeNodesChanged (e.getLocale (), new Object[]{this.getRoot (), e.getLocale ()}, getIndexes (localeKeys, keys), keys);
...
//			} while (baseName==null);
		...
		/*
		 * aggiorna dialog di apertura file sulla directory dell'ultimo file caricato
		 */
	...
	private boolean saveAs (){
		...
		if (saveFileChooser.showSaveDialog (this)==JFileChooser.APPROVE_OPTION){
			...
			if (f.exists ()) {
				...
				java.util.ResourceBundle.getBundle ("com.davidecavestro.rbe.gui.res").getString ("ConfirmDialog.SaveAsOverwriteExistingFile.Message"),
				java.util.ResourceBundle.getBundle ("com.davidecavestro.rbe.gui.res").getString ("ConfirmDialog.SaveAsOverwriteExistingFile.Title"),
...
//			setTreeTableModel (new KeysTreeTableModel ());
		...
		public String getToolTipText () {
			...
			if (row>=0 && col>=0){
				return ((KeysTreeTableModel)getTreeTableModel()).getCommentAt (row, col);
			}
			return null;
		}
		 ...
		 */
		public class KeysTreeTableModel extends DefaultTreeTableModel implements ResourceBundleModelListener, PropertyChangeListener {
...
//				final StringTreeNode root = ;
			...
			public final static int KEY_COLUMN_INDEX = 1;
...
//				});
			...
			public Object getValueAt (Object node, int column) {
				switch (column) {
					...
					default: {
						return _resources.getValue (_locales[column-2], ((StringTreeNode)node).getCompleteKey ());
					}
				}
			}
			...
			public String getCommentAt (int rowIndex, int columnIndex) {
				switch (columnIndex) {
					...
					default: {
						return _resources.getComment (_locales[columnIndex-2],((StringTreeNode)KeysTreeTable.this.getModel ().getValueAt (rowIndex, TREE_COLUMN_INDEX)).getCompleteKey ());
					}
				}
			}
		
			public void setCommentAt (String aValue, int rowIndex, int columnIndex) {
				final String key = ((StringTreeNode)KeysTreeTable.this.getModel ().getValueAt (rowIndex, TREE_COLUMN_INDEX)).getCompleteKey ();
				final Locale l = _locales[columnIndex-2];

				_resources.setComment (l, key, (String)aValue);
...
//								System.out.println ("Setting empty backgound for KEYS treetable");
	...
	private void bindTextAreas (final TextAreaTableBinder t, final EditorPanel editor) {
		/*
		 * @workaround
		 * classe anonima definita esclusivamente per avere uno scope adeguato per le variabili
		 */
		new Object () {
			...
			public void bind (final TextAreaTableBinder t, final EditorPanel editor) {
...
//						if (!t.isShowing ()) {
//							/*
//							 * @workaround per fare il binding delle textarea su due tabelle viùùdiverse.
//							 *la variazione di selezione vienbe ignorata per tabelle nonvisibili
//							 */
//							return;
//						}

						final int col = t.getSelectedColumn ();
						...
						if (
							 ...
							 */
							currentCellPos.setLocation (t.convertColumnIndexToModel (col), t.convertRowIndexToModel (row));
							...
							if (!valueTextAreaUpdating && !valueTextAreaFiring){
								 ...
								 */
								try {
									if (t.convertColumnIndexToModel (col)>t.getKeyColumn ()){
										editor.getValueEditor ().setText ((String)t.getValueAt (row, col));
										editor.getValueEditor ().setEditable (true);
										editor.getValueEditor ().setEnabled (true);
									} else {
										editor.getValueEditor ().setEnabled (false);
										editor.getValueEditor ().setEditable (false);
										editor.getValueEditor ().setText (null);
									}
								} finally {
		...
		//						System.out.println ("Discarded spurious selection change event");
...

							{
								...
								final int viewColumnIndex = t.convertColumnIndexToView (t.getKeyColumn ());
								if (viewColumnIndex>=0 && 
									!editor.getKeyEditor ().hasFocus ()){

									editor.getKeyEditor ().setText ((String)t.getValueAt (row, viewColumnIndex));
								}
							}
							...
							if (!commentTextAreaFiring && 
								...
								try {
									editor.getCommentEditor ().setText ((String)t.getCommentAt ((int)currentCellPos.getY (), (int)currentCellPos.getX ()));
									editor.getCommentEditor ().setEnabled (t.convertColumnIndexToModel (col)>t.getKeyColumn ());
								} finally {
							...
							editor.getKeyEditor ().setEnabled (false);
							editor.getKeyEditor ().setText (null);

							editor.getCommentEditor ().setEnabled (false);
							editor.getCommentEditor ().setText (null);
						}

					}
				};
				t.addRowSelectionListener (l);
				t.addColumnSelectionListener (l);


				/*
				 * propaga le modifiche dalla textarea al modello
				 */
				editor.getValueEditor ().getDocument ().addDocumentListener (new DocumentListener (){
					public void insertUpdate(DocumentEvent e){apply (e);}
					public void removeUpdate(DocumentEvent e){apply (e);}
					public void changedUpdate(DocumentEvent e){apply (e);}
...
//						}
		...
		//				if (editor.getValueEditor ().isEnabled () && editor.getValueEditor ().hasFocus ()) {
						if (editor.getValueEditor ().isEnabled () && 
							editor.getValueEditor ().isEditable () && 
							editor.getValueEditor ().hasFocus () && 
							...
							t.getModel ().setValueAt (editor.getValueEditor ().getText (), (int)currentCellPos.getY (), (int)currentCellPos.getX ());
							} finally {
				 ...
				 * propaga le modifiche dalla textarea al modello
				 */
				editor.getCommentEditor ().getDocument ().addDocumentListener (new DocumentListener (){
					public void insertUpdate(DocumentEvent e){apply (e);}
					public void removeUpdate(DocumentEvent e){apply (e);}
					public void changedUpdate(DocumentEvent e){apply (e);}
...
//						}
						...
						if (!commentTextAreaUpdating && !commentTextAreaFiring/*editor.getCommentEditor ().isEnabled () && editor.getCommentEditor ().isFocusOwner ()*/) {
							commentTextAreaFiring = true;
							/* propaga modifiche alla tabella modifica solo se textarea abilitata, altrimenti sarebbe un evento spurio */
							t.setCommentAt (editor.getCommentEditor ().getText (), (int)currentCellPos.getY (), (int)currentCellPos.getX ());
	...
	/**
	 * Fornisce le informazioni necessarie a collegare le textarea con la tabella
	 */
	private abstract class TextAreaTableBinder {
		private final JXTable _table;
		public TextAreaTableBinder (final JXTable table) {
			_table = table;
		}

		public boolean isShowing () {
			return _table.isShowing ();
		}
		...
		public void addRowSelectionListener (final ListSelectionListener l) {
			_table.getSelectionModel ().addListSelectionListener (l);
		}
		
		public void addColumnSelectionListener (final ListSelectionListener l) {
			_table.getColumnModel ().getSelectionModel ().addListSelectionListener (l);
		}

		private int convertColumnIndexToView (int i) {
			return _table.convertColumnIndexToView (i);
		}

		private Object getValueAt (int row, int viewColumnIndex) {
			return _table.getValueAt (row, viewColumnIndex);
		}

		private int convertColumnIndexToModel (int col) {
			return _table.convertColumnIndexToModel (col);
		}
		
		private int getSelectedRow () {
			return _table.getSelectionModel ().getLeadSelectionIndex ();
		}
		
		private int getSelectedColumn () {
			return _table.getColumnModel ().getSelectionModel ().getLeadSelectionIndex ();
		}
		...
		private int convertRowIndexToModel (int row) {
			return _table.convertRowIndexToModel (row);
		}
		
		public abstract int getKeyColumn ();

		public abstract void setCommentAt (String string, int row, int col);

		public abstract String getCommentAt (int row, int col);


	}
	
	
	private abstract class EditorPanel {
		public abstract JTextField getKeyEditor ();
		public abstract JTextArea getValueEditor ();
		public abstract JTextArea getCommentEditor ();
	}
}
